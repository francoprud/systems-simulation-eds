...
public class SimulationInputGenerator {
	...
	public static void generateRandomInput(int N, MyPoint xVelocityInterval, MyPoint yVelocityInterval)
		...
		double bigParticleRealX = (bigParticleXIndex * (2 * SMALL_RADIUS) + BIG_RADIUS);
		double bigParticleRealY = (bigParticleYIndex * (2 * SMALL_RADIUS) + BIG_RADIUS);

		System.out.println("big x: " + bigParticleXIndex);
		System.out.println("big y: " + bigParticleYIndex);
		System.out.println("big real x: " + bigParticleRealX);
		System.out.println("big real y: " + bigParticleRealY);

		printParticleLine(staticWriter, dynamicWriter, new MyPoint(bigParticleRealX, bigParticleRealY),
		...
		for (int i = 0; i < N; i++) {
			System.out.println("small particle " + i);
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		generateRandomInput(20, new MyPoint(-0.1, 0.1), new MyPoint(-0.1, 0.1));
	}
}
